...
import { characterCatalogFilterCases } from "./character-catalog-filters.cases.js";
...
for (const testCase of [...spriteReactionEngineCases, ...behaviorStudioModelCases, ...characterAnimationCases, ...characterSelectorCases, ...characterCatalogFilterCases]) {
